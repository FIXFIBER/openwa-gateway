#!/usr/bin/env bash
# ============================================================================
# keepalive.cron.sh — serv00 keep-alive + self-heal for OpenWA
# ----------------------------------------------------------------------------
...
# Install on serv00:
#   crontab -e
#   */20 * * * * $HOME/domains/YOURDOMAIN/public_nodejs/openwa/serv00-deploy/keepalive.cron.sh
# ============================================================================
set -e
LOGIN="${SERV00_LOGIN:-yourlogin}"
DOMAIN="${SERV00_DOMAIN:-yourdomain.com}"
REPO_DIR="$HOME/domains/$DOMAIN/public_nodejs/openwa"
...
echo "[keepalive] OpenWA not responding at $(date) — restarting"
