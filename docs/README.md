<p align="center">
  <img src="logo/idawhats_logo.webp" alt="IdaWhats Logo" width="200"/>
</p>

<h1 align="center">IdaWhats Documentation</h1>
<p align="center">
...
| 22  | [n8n Integration](./22-n8n-integration.md)                       | n8n community nodes for IdaWhats                    |
| 23  | [Community Integrations](./23-community-integrations.md)         | Third-party adapters built on the IdaWhats API      |
...
| [Webhook Signature Verification](./examples/webhook-signature-verification.md) | Verify signed IdaWhats webhook deliveries in Node.js and Python |
| [n8n Appointment Booking Workflow](./examples/n8n-appointment-booking.md) | Build an appointment-booking flow with IdaWhats and n8n |
...
IdaWhats seeds a default API key on first run and writes it to:
...
_IdaWhats Documentation · Last updated: 2026-06-18_
