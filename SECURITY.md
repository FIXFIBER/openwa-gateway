...
IdaWhats is a self-hosted WhatsApp API gateway. It handles API-key authentication,
...
- **GitHub Security Advisories** (preferred) — open a private report at
  <https://github.com/FIXFIBER/IdaWhats/security/advisories/new>
- **Email** — yudhi@FIXFIBER.com
...
IdaWhats already ships several hardening measures: API-key auth with roles
...
When exposing IdaWhats, please review the security-relevant configuration documented in
