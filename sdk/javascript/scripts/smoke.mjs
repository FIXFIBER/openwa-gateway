...
if (typeof cjs.IdaWhatsClient !== 'function') throw new Error('CJS: IdaWhatsClient missing');

const esm = await import(new URL('../dist/esm/index.js', import.meta.url).href);
if (typeof esm.IdaWhatsClient !== 'function') throw new Error('ESM: IdaWhatsClient missing');

console.log('smoke OK: require() + import() both resolve IdaWhatsClient');
