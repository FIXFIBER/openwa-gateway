...
use IdaWhats\Exceptions\IdaWhatsAuthException;
...
class ClientTest extends TestCase
{
    ...
    {
        $this->expectException(\IdaWhats\Exceptions\IdaWhatsException::class);
        new \IdaWhats\Client(['baseUrl' => '', 'apiKey' => 'k']);
    }

    public function testRequiresApiKey(): void
    {
        $this->expectException(\IdaWhats\Exceptions\IdaWhatsException::class);
        new \IdaWhats\Client(['baseUrl' => 'https://x', 'apiKey' => '']);
    }
    ...
    public function test401MapsToAuthException(): void
    {
        ...
        $this->expectException(IdaWhatsAuthException::class);
        $backend->makeClient()->sessions->list();
    }
    ...
    public function testTimeoutWithErrno28MapsToTimeoutException(): void
    {
        ...
        // IdaWhatsTimeoutException, regardless of the message wording.
        ...
        $this->expectException(IdaWhatsTimeoutException::class);
        $client->sessions->list();
    }
